...
function Annotations() {
  ...
  useEffect(() => {
    ;[activityPort, annotationsPort].forEach((p) =>
      p.listen((response) => {
                  ...
                  {tabs.map(({ id, label }) => {
                    return (
                      <li
                        ...
                        key={id}>
                        <h2>
                          <Link to={`/annotations/${id}`}>{label}</Link>
                        </h2>
                      </li>
                    )
                  })}
                        ...
                        {...{
                          ...
                          onChange: (data) => {
                            requestPort(
                              annotationsPort,
                              UPDATE_ANNOTATION_COLLECTION,
                              { value: data, id: "creators" }
                            )
                          },
                          onDeleteItem: (id) => {
                            requestPort(annotationsPort, DELETE_ANNOTATION, {
                              collection: "creators",
                              id
                            })
                          }
                      ...
                      <TagsEdition
                        {...{
                          ...
                          onLinkCreators: (tagId, ids) => {
                            const newCreators = Object.entries(
