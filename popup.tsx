        ...
        <div className="actions">
          {
            isLoadingSettings ? null
              :
              <>
                <span className="indicator">enregistrement {settings.recordActivity ? 'actif' : 'en pause'}</span>
                <button
                  onClick={() => {
                    ...
                    settingsPort.send({
                      ...
                      payload: { key: 'recordActivity', value: !settings.recordActivity }
                    })
                  }}
                >{settings.recordActivity ? 'désactiver' : 'activer'}</button>
              </>
          }
        </div>
      </div>
