      ...
      <form
        ...
        <div className="card-body fields">
          <div className="input-group">
            <h5>
              Identifiant sur la plateforme (utilisé pour repérer vos
            ...
            <div className="input-container">
              <input
                ...
                id="id"
                value={id}
                onChange={(e) => setHandle({ ...handle, id: e.target.value })}
              />
            </div>
          </div>
          <div className="input-group">
            ...
            <div className="input-container">
              <input
                ...
                value={alias}
                onChange={(e) =>
                  setHandle({ ...handle, alias: e.target.value })
                }
              />
            </div>
          </div>
          <div className="input-group">
            ...
            <div className="input-container">
              <select
                value={platform}
                onChange={(p) =>
                  setHandle({ ...handle, platform: p.target.value })
                }>
                {PLATFORMS.map((p) => {
                  return (
        ...
        <div className="card-actions">
          <button
            ...
            disabled={JSON.stringify(inputHandle) === JSON.stringify(handle)}
            role="submit">
            Valider
          </button>
          <button
