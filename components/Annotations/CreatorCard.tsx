...
export default function CreatorCard({
  ...
  const availableChannelsMap: AvilableChannelsMapType = useMemo(() => {
    return availableChannels.reduce(
      (res, channel) => ({ ...res, [channel.id]: channel }),
      {}
    )
  }, [availableChannels])
  ...
  const channelsOptions: Array<SelectOption> = useMemo(() => {
    return Object.values(soloChannels).map(
      ({ id, channelName, channelId, platform }) => ({
              ...
              <form
                ...
                <div className="input-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setTempCreator({ ...tempCreator, name: e.target.value })
                    }
                  />
                </div>
