...
const Witness = () => {
  ...
  return (
    <span className="lore-selfie-witness-container">
      <span className="witness-text">
        Enregistrement en cours de votre activité par l'extension lore selfie
        (ces données ne sont jamais partagées automatiquement - retrouvez-les
        sur la page de l'extension)
      </span>
    </span>
  )
}
